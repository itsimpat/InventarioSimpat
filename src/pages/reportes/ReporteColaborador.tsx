        ...
        <>
          {reportLoading ? (
            ...
            <div className="space-y-5">
              ...
              {/* Equipos */}
              <TableSection
                title={`Assigned equipment (${report.equipos.length})`}
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    ...
                    <tr className="bg-gray-50 font-semibold">
                      <td colSpan={3} className="px-5 py-3 text-gray-700">Equipment subtotal</td>
              ...
              {/* Periféricos */}
              <TableSection
                title={`Peripherals (${report.perifericos.length})`}
              ...
              >
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    ...
                    <tr className="bg-gray-50 font-semibold">
                      <td colSpan={3} className="px-5 py-3 text-gray-700">Peripherals subtotal</td>
                      <td className="px-5 py-3 text-right text-gray-900">
              ...
              {/* Licencias */}
              <TableSection
                title={`Active licenses (${report.licencias.length})`}
              ...
              >
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    ...
                    <tr className="bg-gray-50 font-semibold">
                      <td colSpan={3} className="px-5 py-3 text-gray-700">Licenses subtotal</td>
                      <td className="px-5 py-3 text-right text-gray-900">
              ...
              <div className="bg-indigo-600 rounded-xl p-5 text-white">
                <p className="text-sm font-medium text-indigo-200 uppercase tracking-wide mb-1">
                  Total investment for this collaborator
                </p>
              ...
              {report.equipos.length === 0 &&
                ...
                report.licencias.length === 0 && (
                  <EmptyState
                    ...
                    description="This collaborator has no equipment, peripherals, or licenses assigned"
                  />
                )}
            </div>
          )}
